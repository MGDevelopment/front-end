...
def processQuery(nodes, id, query):
    ...
    for row in cursor:
        ...
        data = {
            ...
            "Nombre"                    : tmkSupport.decode(tmkSupport.capitalize(row[4]), encoding),
            "Descripcion"               : tmkSupport.decode(row[5], encoding)
        }
