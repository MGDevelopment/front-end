...
function getVisualizaMensaje() {
    ...
    document.getElementById('msjMax').innerHTML = [
            '<div class="panelMsjTit">',
            'Tenes&nbsp;<span id="totalMsg">',
            '</span> mensajes por leer &gt;</div>',
            '<div class="panelMsjTxt">',
            '<a href="javascript:mostrarDiv(\'msjMin\'); ',
            'javascript:mostrarDiv(\'msjMax\'); ',
            'javascript:setVisualizaMensaje(false);" ',
            'class="panelMsjCerrar">cerrar</a>',
            '<span id="pagMsg"></span> <span id="textoMsgActual"></span> ',
            '<div><a href="javascript:nada()" class="pnlMsgComandos" ',
            'id="msgAnterior">&lt;Anterior</a> | ',
            '<a href="javascript:nada()" class="pnlMsgComandos" ',
            'id="msgSiguiente">Siguiente&gt;</a> | ',
            '<a href="javascript:nada()" class="pnlMsgComandos" ',
            'id="msgLeido">No volver a mostrar este mensaje</a></div>',
            '</div>' ].join('');
    document.getElementById('msjMin').innerHTML = [
            '<div class="panelMsjTxt"><a href="javascript:',
            'mostrarDiv(\'msjMin\'); mostrarDiv(\'msjMax\'); ',
            'setVisualizaMensaje(true)" class="panelMsjAbrir">',
            'abrir panel y ver mensajes</a> </div>' ].join('');
    getMensaje();
}
